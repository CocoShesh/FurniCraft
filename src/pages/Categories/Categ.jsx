...
const Categories = () => {
  ...
  return (
    <section className="bg-[#111827] flex items-center justify-center flex-col">
      <Header />
      <div className="mx-14 pb-20 max-md:m-auto  pt-10 2xl:w-[1500px] text-white max-md:w-full max-lg:w-full max-lg:mx-auto  max-lg:px-5">
        ...
        <h1 className="text-center  text-2xl font-bold uppercase  max-md:mt-10">
          {" "}
          {/* {filter}{" "} */}
        </h1>
          ...
          {filteredProducts.map((product, index) => (
            <div key={index} className=" max-md:h-full max-md:p-auto  ">
              <img
                src={product.src}
                alt={product.name}
                className=" 2xl:w-full  bg-white brightness-90 rounded-lg max-md:h-[300px] w-full max-md:object-contain max-lg:object-contain"
              />
