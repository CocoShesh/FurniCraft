    ...
    <ImageCarousel>
      <div className="flex flex-col justify-center   px-6 py-8 lg:px-8 max-sm:w-auto max-sm:px-5 ">
        ...
        <div className="mt-5 sm:mx-auto sm:w-full sm:max-w-none">
          ...
          <section className=" flex gap-2 mt-5 max-sm:flex-col items-center justify-center ">
            <section className="w-[130px] h-[50px]  max-sm:w-full cursor-pointer  text-white  bg-indigo-600 rounded-md flex justify-center items-center gap-2 font-bold hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
              <SiFacebook className="text-2xl " />
              <p>Facebook</p>
            </section>

            <section className="w-[130px] h-[50px]   max-sm:w-full text-white  cursor-pointer  bg-indigo-600  rounded-md  flex justify-center items-center gap-2 font-bold hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
              <AiFillGoogleCircle className="text-2xl " />
              <p>Google</p>
            </section>
            <section className="w-[130px] h-[50px] text-white  max-sm:w-full   cursor-pointer   bg-indigo-600 flex  rounded-md  justify-center items-center gap-2 font-bold hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
